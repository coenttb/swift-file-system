    ...
    struct Copy {
        ...
        struct EdgeCase {
            ...
            func overwriteDestinationDirectoryFails() throws {
                ...
                try FileManager.default.createDirectory(atPath: destDir, withIntermediateDirectories: false)
                defer {
                    cleanup(sourcePath)
                    cleanup(destDir)
                }
            ...
            func copySymlinkWithoutFollowing() throws {
                ...
                let destTarget = try FileManager.default.destinationOfSymbolicLink(atPath: destPath)
            ...
            func copyAttributesPreservesMetadata() throws {
                ...
                let testDate = Date(timeIntervalSince1970: 1000000000) // 2001-09-09
                ...
                #expect(sourceAttrs[.posixPermissions] as? Int == destAttrs[.posixPermissions] as? Int)
            ...
            func largeFileCopyUsesClone() throws {
                ...
                #expect(elapsed < 0.5, "Large file copy took \(elapsed)s - may not be using clone optimization")
            }
        }
        #endif
        ...
        struct EdgeCase {
            ...
            func largeFileCopyHandlesPartialProgress() throws {
                ...
                let sourceSize = sourceAttrs[.size] as! UInt64
            ...
            func veryLargeFileCopyUsesKernelPath() throws {
                ...
                #expect(elapsed < 5.0, "Large file copy took \(elapsed)s - may not be using kernel optimization")
            }
            ...
            func copyToDirectoryPathThrows() throws {
                ...
                try FileManager.default.createDirectory(atPath: destDirPath, withIntermediateDirectories: false)
                ...
                #expect(throws: File.System.Copy.Error.self) {
                    try File.System.Copy.copy(from: source, to: dest, options: .init(overwrite: true))
                }
            }
            ...
            func copyFromDirectoryThrows() throws {
                ...
                try FileManager.default.createDirectory(atPath: sourceDirPath, withIntermediateDirectories: false)
            ...
            func copyFollowsSymlinkWhenRequested() throws {
                ...
                try File.System.Copy.copy(from: source, to: dest, options: .init(followSymlinks: true))
            ...
            func copySymlinkWithoutFollowing() throws {
                ...
                try File.System.Copy.copy(from: source, to: dest, options: .init(followSymlinks: false))
            ...
            func copyWithoutAttributesNoPermissions() throws {
                ...
                // Set specific permissions on source
                try FileManager.default.setAttributes([.posixPermissions: 0o600], ofItemAtPath: sourcePath)
                ...
                try File.System.Copy.copy(from: source, to: dest, options: .init(copyAttributes: false))

                // Get permissions of both files
                let sourceAttrs = try FileManager.default.attributesOfItem(atPath: sourcePath)
                let destAttrs = try FileManager.default.attributesOfItem(atPath: destPath)

                let sourcePerms = sourceAttrs[.posixPermissions] as! UInt16
                let destPerms = destAttrs[.posixPermissions] as! UInt16
            ...
            func copyWithoutAttributesNoTimestamps() throws {
                ...
                let oldDate = Date(timeIntervalSince1970: 1000000000) // Year 2001
                try FileManager.default.setAttributes([.modificationDate: oldDate], ofItemAtPath: sourcePath)
                ...
                let sourceModTime = sourceAttrs[.modificationDate] as! Date
                let destModTime = destAttrs[.modificationDate] as! Date
            ...
            func copyWithAttributesPreservesPermissions() throws {
                ...
                try File.System.Copy.copy(from: source, to: dest, options: .init(copyAttributes: true))
