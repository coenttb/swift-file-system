...
extension File.System.Metadata.Timestamps {
    ...
    private static func _timeToFileTime(_ time: Time) -> FILETIME {
        ...
        let intervals = (seconds * 10_000_000) + (nanoseconds / 100) + 116444736000000000
        return FILETIME(
            dwLowDateTime: DWORD(intervals & 0xFFFFFFFF),
            dwHighDateTime: DWORD((intervals >> 32) & 0xFFFFFFFF)
        )
    }
