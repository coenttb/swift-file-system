...
extension POSIXAtomic {
    ...
    private static func verifyParentDirectory(_ dir: String) throws(File.System.Write.Atomic.Error) {
        var st = stat()
...
extension POSIXAtomic {
    ...
    private static func statIfExists(_ path: String) throws(File.System.Write.Atomic.Error) -> stat? {
        var st = stat()
    ...
    private static func createTempFile(at path: String) throws(File.System.Write.Atomic.Error) -> Int32 {
    ...
    private static func writeAll(_ bytes: borrowing Swift.Span<UInt8>, to fd: Int32) throws(File.System.Write.Atomic.Error) {
...
extension POSIXAtomic {
    ...
    private static func atomicRename(from: String, to: String) throws(File.System.Write.Atomic.Error) {
    ...
    private static func atomicRenameNoClobber(from: String, to: String) throws(File.System.Write.Atomic.Error) {
        #if os(Linux)
    ...
    private static func tryRenameat2NoClobber(from: String, to: String) -> Result<Void, File.System.Write.Atomic.Error>? {
...
extension POSIXAtomic {
    ...
    private static func copyTimestamps(from st: stat, to fd: Int32) throws(File.System.Write.Atomic.Error) {
        #if canImport(Darwin)
        var times = [
...
extension POSIXAtomic {
    ...
    private static func copyExtendedAttributes(from srcPath: String, to dstFd: Int32) throws(File.System.Write.Atomic.Error) {
        #if canImport(Darwin)
    ...
    #if canImport(Darwin)
    private static func copyXattrsDarwin(from srcPath: String, to dstFd: Int32) throws(File.System.Write.Atomic.Error) {
        ...
        while offset < gotSize {
            ...
            let name = String(decoding: nameList[offset..<end].map { UInt8(bitPattern: $0) }, as: UTF8.self)
            offset = end + 1
    ...
    #if os(Linux)
    private static func copyXattrsLinux(from srcPath: String, to dstFd: Int32) throws(File.System.Write.Atomic.Error) {
        // Get list of xattr names
...
extension POSIXAtomic {
    ...
    private static func copyACL(from srcPath: String, to dstFd: Int32) throws(File.System.Write.Atomic.Error) {
